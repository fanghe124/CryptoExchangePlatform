...
$sql4 = "truncate $second_table_name;";
$sql6 = "INSERT INTO $cointag (Block, Anual, Daily, Start)
...
if ($conn->query($sql5) === TRUE) {
    echo "PROCCESSING: 100% <br>  <br> <a href='admin.php'> << Return</a>";
} else {
